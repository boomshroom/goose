...
func (desc IDTDesc)Pack() (i IDTDescPacked) {
...
func SetupIRQ() {
	...
	table[32] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq0)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[33] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq1)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[34] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq2)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[35] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq3)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[36] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq4)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[37] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq5)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[38] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq6)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[39] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq7)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[40] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq8)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[41] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq9)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[42] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq10)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[43] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq11)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[44] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq12)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[45] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq13)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[46] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq14)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
	table[47] = IDTDesc{Offset: uint32(ptr.FuncToPtr(irq15)), Selector: 0x08, TypeAttr: 0x8E}.Pack()
